...
class PaymentTransac extends Component {
  constructor(props) {
    super(props);
    ...
    this.data = { apikey: process.env.REACT_APP_MAZZUMA_API, option: "get_balance" };
  }
      ...
      <div className="card-body">
        ...
        <div className="container my-3 bg-light">
          <div class="col-md-12 text-center">
            <button type="button" className="btn btn-primary mr-3" onClick={this.message}> 
              Check Balance
            </button>
